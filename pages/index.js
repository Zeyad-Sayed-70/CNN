...
async function getDataByPage(page) {
  const res = await fetch(
    `https://newsapi.org/v2/everything?q=${searchTitle}&from=2022&pageSize=20&sortBy=publishedAt&page=${page}&apiKey=e5c0fba38cf448b0a5bf824c9ab12238`
  );
...
export async function getServerSideProps(context) {
  const res = await fetch(
    "https://newsapi.org/v2/everything?q=world&from=2022&page=1&pageSize=20&sortBy=publishedAt&apiKey=e5c0fba38cf448b0a5bf824c9ab12238"
  );
  const data = await res.json();
  return {
    props: { data },
